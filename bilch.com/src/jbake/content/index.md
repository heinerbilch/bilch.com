title=OS multiprocessor performance evaluation
date=2015-09-25
type=page
tags=benchmarks
status=published
...
Explicit parallelism is by domain decomposition and message-passing. This version of  [Sweep3D](blog/2015/sweep3d-benchmark.html) supports MPI message passing libraries as well as a single processor version. Here is a [description](http://wwwc3.lanl.gov/pal/software/sweep3d/sweep3d_readme.html) Here are [older benchmarks](http://www.cs.rice.edu/~alc/superpages/) where I found the starting point.
...
[Fortran Coarrays](https://bitbucket.org/sourceryinstitute/opencoarrays)
